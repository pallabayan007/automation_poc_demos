    ...
    this.$get = ['$interval', '$log', '$rootScope', '$document', 'Keepalive', 'IdleLocalStorage', '$window',
      function($interval, $log, $rootScope, $document, Keepalive, LocalStorage, $window) {
        ...
        function timeout() {
          ...
          /*Added code for redirect page on timeout*/
          ...
          if(pagename == 'admin'){
              ...
              if(deploy_type=="CLOUD")
               ...
               logoutURl=logoutDomain;
              
        	  alert('Your session has expired! Please log in again.');
        	  //console.log(logoutDomain);
			  //var logoutURl= logoutDomain + '/idaas/mtfim/sps/idaas/logout';
		  ...
		  $.get(logout, function( data ) {		
	    	//$http.get(logout).success(function(data) {
	    		...
	    		document.cookie = 'PD-S-SESSION-ID=; expires=Thu, 01 Jan 1970 00:00:01 GMT;';
	    		document.cookie = 'PD_STATEFUL_fbfc67f2-f58a-11e4-aad0-000c2923af23=; expires=Thu, 01 Jan 1970 00:00:01 GMT;';
	    		document.cookie = 'WASReLoginURL=; expires=Thu, 01 Jan 1970 00:00:01 GMT;';
	    		document.cookie = 'WASReqURL=; expires=Thu, 01 Jan 1970 00:00:01 GMT;';	
	    		localStorage.clear();
	    		console.log("calling: "+logoutDomain);
				var logoutURl= logoutDomain + '/idaas/mtfim/sps/idaas/logout';
	    		window.location.href = logoutURl;
	    		//window.location.href = docDomain;
	      });
	      console.log("Authorization cancelled for Logout!");		
          /*Finish Code for redirection*/         
        }
