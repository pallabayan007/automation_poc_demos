...
// Set up the input box to underline text as it is typed
  ...
  function displayMessage(newPayload, typeValue) {
	...
	if (newPayload.output){
	  ...
	  //document.getElementById("textVoiceOutput").value = newPayload.output.text;
	  voiceMsg(newPayload.output.text);
	  //voiceMsg(document.getElementById("textVoiceOutput").value);
	  //console.log("=====document.getElementById.value from display message function conv js==== "+document.getElementById("textVoiceOutput").value);
	}   	
        ...
        var messageJson = {
          ...
          'children': [{
            ...
            'children': [{
              ...
              'children': [{
                // <p class='watson-msg'> {messageText}</p>
                'tagName': 'p',
				'classNames': ['watson-msg'],
                'text': currentText
              }]
            }]
          }]
...
function voiceMsg(msg){
	console.log("Inside voice call==============" + msg);
	if (msg !== null) {
