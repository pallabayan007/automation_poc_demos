...
exports.initialDataLoad = function (req, res){
	//For Docker it will always be an empty database, no records will be available
	//To be sure, check manually before setup the docker, delete the records if exists
	dataload(req,res);
}
