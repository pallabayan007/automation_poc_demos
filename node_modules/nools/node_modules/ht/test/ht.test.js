...
it.describe("ht",function (it) {
    ...
    it.describe("iterating over values ", function (it) {
        var table = new HashTable();
        array(entrySet).forEach(function (es) {
        ...
        it.should("#map", function () {
            ...
            array(ret).forEach(function (i, j) {
                assert.equal(i, j);
            });
        });
        ...
        it.should("#some", function () {
            assert.isFalse(table.some(function (entry) {
                return !entry;
            }));
            assert.isTrue(table.some(function (entry) {
                return entry;
            }));
        });

        it.should("#every", function () {
            assert.isFalse(table.every(function (entry) {
                return !entry;
            }));
            assert.isTrue(table.every(function (entry) {
                return entry;
            }));
        });
